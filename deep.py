...
def load_gradcam(_model):
    # leading underscore tells st.cache_resource not to try hashing the model
...
with tab1:
    ...
    # ---- Run prediction + Grad-CAM once, shared by col2 and col3 ----
    label = confidence = prob_fake = cam_image = None
    if uploaded:
    ...
    with col3:
        ...
        if uploaded:
            ...
            st.info("Heatmap will appear here after upload.")
